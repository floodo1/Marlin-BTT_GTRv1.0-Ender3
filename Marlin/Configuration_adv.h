...
// per marlin config example for Ender3:
   ...
   */
  // per marlin config example for Ender3 (and default?):
...
#define USE_CONTROLLER_FAN
  ...
  // myconfig: confirmed turn on speed is 136 with stock creality 40mm controller fan
  #define CONTROLLERFAN_SPEED_MIN    136 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
  #define CONTROLLERFAN_SPEED_ACTIVE 255 // (0-255) Active speed, used when any motor is enabled
  // myconfig: todo: confirm that PWM noise is so annoying at idle that we want to turn fan off
...
// When first starting the main fan, run it at full speed for the given number of milliseconds.  This gets the fan spinning reliably
 ...
 */
#define FAN_MIN_PWM 60  // myconfig: 60 for stock creality part cooling fan
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50   // temp above which the fan turns on
...
// myconfig: enable this for safety?
...
#define ENCODER_RATE_MULTIPLIER
  ...
  // per marlin config example for Ender3 v2:
  #define ENCODER_5X_STEPS_PER_SEC    30   // default, does not exist
  #define ENCODER_10X_STEPS_PER_SEC   80  // (steps/s) Encoder rate for 10x speed, default 30
  #define ENCODER_100X_STEPS_PER_SEC  130  // (steps/s) Encoder rate for 100x speed, default 80
#endif
...
// per https://danielstanton.co.uk/357/configuring-marlin-2-0-for-an-ender-3-pro-and-bltouch/
...
//#define LCD_SHOW_E_TOTAL
  ...
  // #define SDCARD_SORT_ALPHA
    ...
    // per marlin config example for Ender3 v2: true
 ...
 */
// per marlin config example for Ender3: commented
// per marlin config example for Ender3 v2
 ...
 */
// per marlin config example for Ender3 and Ender3 v2: uncommented
// myconfig: temporarily disable
#define BABYSTEPPING
  ...
  // uncomment per https://danielstanton.co.uk/357/configuring-marlin-2-0-for-an-ender-3-pro-and-bltouch/
 ...
 */
// uncomment per BABYSTEP_ZPROBE_GFX_OVERLAY :
#define LIN_ADVANCE
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  // #define LIN_ADVANCE_K 0.22    // Unit: mm compression per 1mm/s extruder speed
  // 0= functionally disabled, but 0 value can be overwritten via g-code
 ...
 */
// enable per https://github.com/1larity/Marlin/blob/2.0.x/Marlin/Configuration_adv.h
// per ender3 stock firmware github: enable
#define ADVANCED_PAUSE_FEATURE
  ...
  // default value = 10
  // per ender3 stock firmware github: 5
 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
  // per marlin config example for Ender3: 580 (vs 800)
  ...
  #if AXIS_IS_TMC(E0)
  // per marlin config example for Ender3: 650 (vs 800)
   ...
   */
  // per https://www.youtube.com/watch?v=hRpWtx3HCGM
