...
//
  // BigTreeTech example has: FSMC_GRAPHICAL_TFT which matches Configuration.h
  //
  // FSMC Graphical TFT
  //
 ...
 */
#define BABYSTEPPING  // per marlin config example for Ender3 v2: true
  ...
  // per marlin config example for Ender3 v2: 40, marlin = 1
